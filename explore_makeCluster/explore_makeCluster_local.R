...
# explore makeCluster - step by step
...
# Part 4 - VB Ubuntu manual mode, 1 vCPU
cl <- makeCluster(
    spec = c(IP_UbuntuVM),
    master = IP_local, 
    port = 11011,
...
# Part 5a - UbuntuVM automode mode, 1 vCPU, failure
# stop R and examine Warning message
cl <- makeCluster(
    spec = c(IP_UbuntuVM),
    master = IP_local, 
    port = 11011,
...
# Part 5b - UbuntuVM automode mode, 1 vCPU, failure
# stop R and examine Warning message
